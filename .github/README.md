...
[`@aws-sdk/client-bedrock-agent`](https://www.npmjs.com/package/@aws-sdk/client-bedrock-agent/v/3.1048.0).
...
- @aws-sdk/client-bedrock-agent - [https://cloud-sdk-builds.github.io/?sdk=client-bedrock-agent](https://cloud-sdk-builds.github.io/?sdk=client-bedrock-agent)
- @aws-sdk/client-bedrock-agent v3.1048.0 - [https://cloud-sdk-builds.github.io/?sdk=client-bedrock-agent&version=3.1048.0](https://cloud-sdk-builds.github.io/?sdk=client-bedrock-agent&version=3.1048.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent@3.1048.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CmOBpsa6tSWsI0wInLJ/NuTtH39MgrK8Xae5Gn0qyApurBm2PmsxA06MAr32aWUo
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-bedrock-agent": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent@3.1048.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-bedrock-agent@3.1048.0/index.min.mjs": "sha384-CmOBpsa6tSWsI0wInLJ/NuTtH39MgrK8Xae5Gn0qyApurBm2PmsxA06MAr32aWUo"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-bedrock-agent";
...
```
https://github.com/cloud-sdk-builds/client-bedrock-agent/blob/refs/tags/3.1048.0/LICENSE
```
